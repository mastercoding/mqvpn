                 ...
                 void *user_ctx)
{
    ...
    mqvpn_conn_settings_input_t cs_input = {
         ...
         * here, unlike recv_rate_bytes_per_sec two fields up: for an upload
         * this process is the receiver holding the same per-request buffers
         * the client holds on a download. */
